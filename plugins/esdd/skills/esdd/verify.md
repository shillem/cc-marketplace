...
1. **Select the change:**
   ...
   - Otherwise, run the CLI script: `node <skill-dir>/scripts/cli.mjs list`
...
4. **Verify the change:**
   ...
   If discrepancies were found, use the ask tool with a brief discrepancy summary and these choices:
