...
- Get instructions: `node "${CLAUDE_SKILL_DIR}/scripts/cli.mjs" instructions "<change-name>" --plan --artifact <artifact>`
...
- After creating the artifact, run `node "${CLAUDE_SKILL_DIR}/scripts/cli.mjs" status "<change-name>" --plan`
