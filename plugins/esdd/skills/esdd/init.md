...
1. **Survey the project:**
   Run `node "${CLAUDE_SKILL_DIR}/scripts/cli.mjs" init --survey`.
...
4. **Run init script:**
   Run `node "${CLAUDE_SKILL_DIR}/scripts/cli.mjs" init --create --workflow "<chosen-workflow>" [--domain "name:description"]...`.
