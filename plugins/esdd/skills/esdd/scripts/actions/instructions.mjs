...
import { parseArg, parsePhases } from "../lib/init.mjs";
import {
...
export function run(args) {
  ...
  if (!changeName || !phase) {
    outputError(
      "Usage: cli.mjs instructions <name> --plan --artifact <artifact> | --apply --artifact <artifact> --group <group-id> | --archive --artifact <artifact>"
    );
    process.exit(1);
  }
