...
5.  Draft the title and body from the full branch:
    ...
    - Avoid using a PR title that exactly duplicates a commit subject. The PR title should summarize the overall branch; commit subjects should summarize individual commits.
