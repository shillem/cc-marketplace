...
| [code-swiss-knife](plugins/code-swiss-knife/) | Development toolbox plugin with `code-reviewer` for focused reviews, `gitter` for commit and pull request workflows, and `context7-docs` for current version-specific docs and examples |
